...
namespace TsMap.Canvas
{
    public partial class TileMapGeneratorForm : Form
    {
        ...
        private ExportFlags GetExportFlags()
        {
            ...
            if (triStateTreeView1.GetCheckedByNodeName("GenRouteAdvisor")) exportFlags |= ExportFlags.RouteAdvisor;
            if (triStateTreeView1.GetCheckedByNodeName("GenFerryList")) exportFlags |= ExportFlags.FerryList;
            if (triStateTreeView1.GetCheckedByNodeName("GenGraph")) exportFlags |= ExportFlags.Graph;
